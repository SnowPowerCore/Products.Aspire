...
namespace Products.PublicApi.Api
{
    ...
    // - Add your file transfer manager while calling ConfigureProductsBackendApiApizrManagers method thanks to its options builder parameter
    ...
    public static partial class IServiceCollectionExtensions
    {
        ...
        /// <returns></returns>
        public static IServiceCollection ConfigureProductsBackendApiApizrManagers(
