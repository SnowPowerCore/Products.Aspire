...
public class DeleteProductEndpoint : EndpointWithoutRequest<ApiResponse?>
{
    ...
    public override void Configure()
    {
        ...
        Description(b => b
            ...
            .Produces<ApiResponseForOpenApi<ProductDeletedResponseDto>>((int)HttpStatusCode.OK, MediaTypeNames.Application.Json)
    ...
    public DeleteProductEndpoint(IProductService product)
    {
        _product = product;
    }
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        var result = await _product.DeleteProductAsync(id, ct);
