...
public class UpdateProductEndpoint : Endpoint<ProductRequestDto, ApiResponse?>
{
    ...
    public UpdateProductEndpoint(IProductService product)
    {
        _product = product;
    }
    ...
    public override async Task HandleAsync(ProductRequestDto req, CancellationToken ct)
    {
        ...
        var result = await _product.UpdateProductAsync(id, req, ct);
